		...
		<div class='login'>
			...
			<div class='login_fields'>
				<div class='login_fields__user'>
					...
					<input name="stuid" id="Stuid" placeholder='用户名' maxlength="16" type='text' autocomplete="off" value="" />
				...
				<div class='login_fields__password'>
					...
					<input name="password" type="password" placeholder='密码' maxlength="16" type='text' autocomplete="off">
					<div class='validation'>
						<img alt="" src='img/tick.png'>
					</div>
				</div>
