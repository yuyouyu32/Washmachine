		...
		<div class='login'>
			...
			<div class='login_fields'>
				<div class='login_fields__user'>
					...
					<input name="id" id="id" placeholder='用户名' maxlength="16" type='text' autocomplete="off" value="" />
				...
				<div class='login_fields__password'>
					...
					<input name="oldpwd" type="password" placeholder='原密码' maxlength="16" type='text' autocomplete="off">
					<div class='validation'>
						<img alt="" src='img/tick.png'>
					</div>
				</div>
				<div class='login_fields__password'>
					...
					<input name="pwd" type="password" placeholder='新密码' maxlength="16" type='text' autocomplete="off">
					<div class='validation'>
						<img alt="" src='img/tick.png'>
					</div>
				</div>
				<div class='login_fields__password'>
					...
					<input name="ackpwd" type="password" placeholder='确认密码' maxlength="16" type='text' autocomplete="off">
					<div class='validation'>
						<img alt="" src='img/tick.png'>
					</div>
				</div>
			...
			<div class='disclaimer'>
				<span style="color: yellow">${xiaoxi}</span>
			</div>
		</div>
		</form>
		<div class='authent'>
